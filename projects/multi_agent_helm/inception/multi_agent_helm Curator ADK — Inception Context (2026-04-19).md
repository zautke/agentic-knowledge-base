---
title: multi_agent_helm Curator ADK — Inception Context (2026-04-19)
type: context
permalink: projects/multi-agent-helm/inception/multi-agent-helm-curator-adk-inception-context-2026-04-19
project: agent-kb
cross_project: multi_agent_helm
status: inception
date: 2026-04-19
tags:
- project/multi_agent_helm
- agent/curator-adk
...
# multi_agent_helm Curator ADK — Inception Context (2026-04-19)

**Cross-project pointer.** This note exists in the global `kb` project so that future searches across the agentic KB surface the `multi_agent_helm` project. The authoritative entity notes live in the dedicated `multi_agent_helm` Basic-Memory project rooted at `/Volumes/MACDEV/multi_agent_helm/.basic-memory`.
...
The `multi_agent_helm` repository follows a dual-KB persistence pattern (precedent: `graphrag-off-main-kb`):
...
- governed_by [[fundamentals/curator-handover-knowledge]]
- references [[fundamentals/fundamental-agent-kb]]
